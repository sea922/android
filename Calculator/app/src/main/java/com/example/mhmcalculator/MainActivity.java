...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String result = mySharedPreferences.getResult();
        String string_calc = mySharedPreferences.getStringCalc();
        tvDisplay = findViewById(R.id.tv_display);
        tvPhrase = findViewById(R.id.tv_phrase);

        if (!result.equals("")) {
            tvDisplay.setText(result);
            tvPhrase.setText("=" + string_calc);
        } else {
            tvDisplay.setText("0");
            tvPhrase.setText("");
        }
        ...
        btnEqual.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                tvPhrase.setText(num1 + " " + op + " " + num2 + " = " + strResult);
                mySharedPreferences.saveResult(strResult);
                mySharedPreferences.saveStringCalc(num1 + " " + op + " " + num2);
                isEqualPressed = true;
